...
1. Begin the program.
2. 2. Define the Student class with an init method to initialize name and student_id, and a method get_student_info() to return student details.
...
### OUTPUT
<img width="780" height="312" alt="image" src="https://github.com/user-attachments/assets/78726973-95a0-4924-b85b-a52b2700982c" />
